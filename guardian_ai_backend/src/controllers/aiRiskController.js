...
async function chatSafetyCoach(req, res) {
  try {
    ...
    if (!isSuccess || !reply) {
      // Intelligent fallback logic for General Mode, Security Mode, and Legal Information Mode
      ...
      if (lower.includes('25') && (lower.includes('16') || lower.includes('*') || lower.includes('x'))) {
        ...
        reply = `Translating to Indonesian:\n"Saya adalah Provo Guard AI yang siap membantu Anda dalam pertanyaan umum, keamanan digital, maupun informasi hukum."`;
      ...
      } else if (lower.includes('is hacking someone illegal') || lower.includes('is hacking illegal') || lower.includes('access someone\'s account')) {
        reply = `**Short Answer**\nYes. Accessing computer systems, social media accounts, or private data belonging to another person without authorization is illegal under computer crime laws worldwide.\n\n**Jurisdiction**\nGeneral legal principles apply globally across computer crime statutes (e.g., US Computer Fraud and Abuse Act, UK Computer Misuse Act, and equivalent cybercrime legislation in most countries).\n\n**Relevant Legal Principles**\n• Technical Security: Unauthorized access violates access control standards and user credential security.\n• Legal Rule: Accessing or exceeding authorized access to computer systems without permission is a criminal offense subject to fines and potential imprisonment.\n\n**How It May Apply**\nEven if someone previously shared credentials or password information, accessing an account without ongoing explicit authorization may still constitute illegal computer access.\n\n**Important Exceptions**\nAuthorized penetration testing conducted by certified security professionals under explicit, written Bug Bounty or authorization agreements.\n\n**What You Can Do Next**\n1. If your account was compromised, reset your password immediately across all services.\n2. Enable Multi-Factor Authentication (MFA).\n3. Document unauthorized login timestamps and report the incident to platform support and law enforcement.\n\n**When to Contact a Lawyer**\nConsult a legal professional or report to national cybercrime authorities if unauthorized access resulted in financial extortion, identity theft, or corporate espionage.`;
      } else if (lower.includes('breach of contract')) {
        reply = `**Short Answer**\nBreach of contract occurs when one party fails to perform a legally binding obligation set forth in an agreement without a lawful legal excuse.\n\n**Jurisdiction**\nContract principles generally apply in common law and civil law jurisdictions, though specific remedies depend on your country and state/province.\n\n**Relevant Legal Principles**\n• **Material Breach:** A major failure that strikes at the core of the contract.\n• **Minor Breach:** A minor deviation that does not invalidate the entire agreement.\n• **Anticipatory Breach:** One party indicates in advance they will not perform.\n\n**What You Can Do Next**\n1. Review the written agreement to confirm the exact terms and obligations.\n2. Document evidence of non-performance or communications.\n3. Send formal written notice of breach requesting remediation.\n\n**When to Contact a Lawyer**\nContact a qualified attorney if significant financial damages or ongoing legal disputes are involved.`;
      } else if (lower.includes('landlord') || lower.includes('evict') || lower.includes('tenant')) {
        reply = `**Short Answer**\nIn most jurisdictions, a landlord cannot forcibly evict a tenant or alter lease terms without following proper statutory notice procedures and court processes.\n\n**Jurisdiction**\nResidential landlord-tenant laws vary significantly by country, state/province, and municipality. Which country and state/province are you located in?\n\n**Relevant Legal Principles**\n• Self-help evictions (e.g., changing door locks, removing belongings, or shutting off utilities) are illegal in most residential tenancy statutes.\n• Written advance notice specifying statutory grounds is typically required before initiating eviction proceedings.\n\n**How It May Apply**\nBased on the facts provided, if your landlord acted without proper written notice or judicial process, their actions may violate tenant protection laws.\n\n**Important Exceptions**\nExceptions may exist for severe lease violations, emergency structural hazards, or specific temporary lodging arrangements.\n\n**What You Can Do Next**\n1. Gather and save your written lease agreement, payment receipts, and messages.\n2. Request written clarification of the landlord's action.\n3. Contact a local tenant advocacy group or housing authority.\n\n**When to Contact a Lawyer**\nContact a qualified local tenant rights attorney or legal aid organization immediately if facing active lockouts, utility shut-offs, or formal eviction court summonses.`;
      } else if (lower.includes('report') && (lower.includes('scam') || lower.includes('fraud') || lower.includes('stole'))) {
        reply = `**Short Answer**\nYes, you can and should report online scams and account theft to both technical platform support and official law enforcement authorities.\n\n**Jurisdiction**\nReporting mechanisms depend on your location, but most jurisdictions have designated national cybercrime reporting portals.\n\n**Relevant Legal Principles**\n• Online fraud, phishing, and account takeover constitute illegal financial and computer crimes.\n• Technical platforms are obligated to investigate account hijacking reports under terms of service and consumer privacy laws.\n\n**What You Can Do Next**\n1. Technical Action: Lock your account, reset passwords, and revoke active sessions.\n2. Preserve Evidence: Export chat logs, headers, and transaction receipts into your Encrypted Evidence Vault.\n3. Official Report: File a complaint with national cybercrime portals (e.g., FBI IC3 in the US, Action Fraud in the UK, or local cyber police).\n\n**When to Contact a Lawyer**\nSeek legal advice if the scam resulted in major financial loss, identity theft, or unauthorized loan applications in your name.`;
      } else if (lower.includes('arrest') || lower.includes('police') || lower.includes('court') || lower.includes('summons') || lower.includes('lawsuit') || lower.includes('sue')) {
        reply = `**Short Answer**\nFacing police inquiries, formal summonses, or court lawsuits requires careful attention to your legal rights and procedure.\n\n**Jurisdiction**\nCriminal procedure and court deadlines strictly depend on your local jurisdiction and court system.\n\n**Relevant Legal Principles**\n• Individuals generally have procedural rights to legal representation, formal notice of allegations, and due process.\n• Statements made without legal counsel can significantly affect legal outcomes.\n\n**What You Can Do Next**\n1. Request formal written details of any claim or charge.\n2. Avoid discussing case facts on public social media or with third parties.\n3. Keep copies of all official paperwork in a safe location.\n\n**When to Contact a Lawyer**\nYou should contact a qualified local defense or litigation attorney immediately to protect your rights and adhere to strict court deadlines.`;
      } else if (lower.includes('immigration') || lower.includes('visa') || lower.includes('deportation')) {
        reply = `**Short Answer**\nImmigration rules, visa statuses, and residency permissions depend strictly on country laws and official government immigration policies.\n\n**Jurisdiction**\nImmigration laws are strictly national and enforced by official government immigration authorities.\n\n**Relevant Legal Principles**\n• Visa categories dictate specific work, study, and stay authorizations.\n• Official government portals (e.g., USCIS, UK Visas & Immigration) provide binding requirements.\n\n**What You Can Do Next**\n1. Verify your current visa expiration date and documentation status.\n2. Consult official government immigration agency websites.\n\n**When to Contact a Lawyer**\nConsult a licensed immigration lawyer or accredited legal representative before submitting complex applications or if facing status challenges.`;
        ...
        reply = `I am Provo Guard AI, your general-purpose assistant for knowledge, programming, digital safety, and responsible legal information.\n\nHow can I help you today?`;
      }
    }
